															...
															<div class="card">
																<div class="card-body">
																	...
																	<br>
																		...
																		<a href="favoritebeneficiari.php?delete=<?php echo $row["id"];?>"><i style="color:red;" class="fa fa-trash-o" aria-hidden="true"></i> Remove</a>
																	</p>
																</div>
															</div>
														</div>
															...
															<div class="card">
																<div class="card-body">
																	...
																	<br>
																		...
																		<a href="favoritebeneficiari.php?favorit=<?php echo $row["id"];?>"><i style="color:#F6F640;" class="fa fa-star" aria-hidden="true"></i>Add to favorite</a>
																	</p>
																</div>
															</div>
														</div>
